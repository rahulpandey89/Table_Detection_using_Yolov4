...
outpath = "Labels/output_tables/"  # where to store the final output txt file
...
cls = "tables"   # on this object we want to train
if cls not in classes:
    exit(0)
cls_id = classes.index(cls)

#wd = getcwd()
wd='C:/Users/ankur/Documents/Yolov4'
...
for txt_name in txt_name_list:
    ...
    for line in lines:
        ...
        if(len(line) >= 2):
            ...
            print(elems)
            print("finshed first")
            print(list(elems.split(',')))
            elems=list(elems.split(','))
            try:
              xmin = elems[0]
              print(xmin,'-------------')
              xmax = elems[2]
            ...
            # print(xmin)
            print(w, h)
            print(xmin,xmax,ymin,ymax,'rrrrrrrrrrrrrrrr')
